...
//+kubebuilder:rbac:groups=db-operator.kubemaster.com,resources=s3storages,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=db-operator.kubemaster.com,resources=s3storages/status,verbs=get;update;patch
...
// the S3Storage object against the actual cluster state, and then
...
func (r *S3StorageReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dboperatorv1alpha1.S3Storage{}).
		Complete(r)
}
